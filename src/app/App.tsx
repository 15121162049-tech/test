...
import PhoneRatioCard from './components/PhoneRatioCard';
        ...
        <div className="absolute inset-0 rounded-lg bg-gradient-to-b from-slate-700 to-slate-800 p-[12px] shadow-2xl">
          ...
          <div className="relative w-full h-full rounded-md overflow-hidden bg-black border border-slate-900/50">
            ...
            <div className="size-full relative overflow-hidden">
              ...
              {/* 顶部状态栏 */}
              <div className="absolute top-0 left-0 right-0 h-8 z-[100] backdrop-blur-md bg-black/15 border-b border-white/10">
              ...
              {/* 主内容区域 */}
              <div className="pt-8 pb-14 size-full">
                <AdaptiveHeightCard />
                {/* <PhoneRatioCard /> */}
              </div>
            </div>
